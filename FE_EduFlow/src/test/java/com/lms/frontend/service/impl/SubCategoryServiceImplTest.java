...
public class SubCategoryServiceImplTest {
    ...
    void testGetAllCategories_Success() {
        ...
        subCategoryResponse.setSubCategoryId(1L);
        subCategoryResponse.setSubCategoryName("Java");

        ApiResponse<List<SubCategoryResponse>> apiResponse = new ApiResponse<>();
        apiResponse.setStatus("SUCCESS");
        apiResponse.setPayload(Collections.singletonList(subCategoryResponse));
        ...
        ApiResponse<List<SubCategoryResponse>> result = subCategoryService.getAllCategories(1, 10);

        assertNotNull(result);
        assertEquals("SUCCESS", result.getStatus());
        assertEquals(1, result.getPayload().size());
        assertEquals("Java", result.getPayload().get(0).getSubCategoryName());
    }
