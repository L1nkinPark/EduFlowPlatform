...
- Nhật ký công việc và phần hackathon liên kết trực tiếp tới repository và commit kỹ thuật.
...
- Hoàn thiện quy trình phát triển từ phân tích yêu cầu, xây dựng chức năng, kiểm thử đến triển khai ứng dụng trên AWS.
- Vận dụng kiến thức Spring Boot, bảo mật, Docker, Terraform, Amazon ECS Fargate và CI/CD vào một hệ thống thực tế.
- Nâng cao kỹ năng phối hợp nhóm, phát triển sản phẩm trong các hackathon và trình bày kết quả bằng tài liệu kỹ thuật song ngữ.
